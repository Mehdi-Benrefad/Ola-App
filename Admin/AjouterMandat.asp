					...
					<table align="center" border="0" cellspacing="0" cellpadding="0" style="width:360px;font-weight:bold;" id="TabForm">
                        ...
                        <tr height="25">
							...
							<td align="left" valign="center">
								<input type="date" name="DateD" id="DateD" maxlength="50"  style="width:210px;" required value="<%=DateD%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						<tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
								<input type="date" name="DateF" id="DateF" maxlength="50" required  style="width:210px;" value="<%=DateF%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						 <tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
