...
If (Len(Session("IdAdmin")) > 0) Then
    ...
    Elseif(Instr(Session("PageTitle"), "Login/Logout")) Then
        ...
        li3 = "active"
        li4 = ""
    Elseif(Instr(Session("PageTitle"), "Syndic")) Then
        li1 = ""
        li2 = ""
        li3 = ""
        li4 = "active"
  ...
  <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown <%=li4%>" style="padding-right:30px;">
        <a class="nav-link dropdown-toggle" href="#" id="dropdown08" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Syndicat</a>
        <div class="dropdown-menu" aria-labelledby="dropdown09">
          ...
          <a class="dropdown-item" href="AjouterMandat.asp" title="Gestion Mandat">Ajouter Mandat</a>
