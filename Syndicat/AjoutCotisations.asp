				...
				<form name="CompteForm" id="CompteForm" action="CotisationsAction.asp" method="post">
					<table align="center" border="0" cellspacing="0" cellpadding="0" style="width:420px;font-weight:bold;" id="TabForm">
		                ...
		                <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
								<input type="text" name="TMontant" id="TPass" maxlength="10" style="width:210px" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						<tr height="10">
							<td align="center" valign="center" colspan="3">
		                ...
		                <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
								<input type="text" name="TMoyen" id="TNom" maxlength="50" style="width:210px" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						<tr height="10">
							<td align="center" valign="center" colspan="3">
