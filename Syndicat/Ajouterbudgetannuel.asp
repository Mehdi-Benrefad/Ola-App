...
<html lang="fr">
    ...
    <body>
        ...
        <!--<div class="jumbotron">-->
				<form name="CompteForm" id="CompteForm" action="BudgetAction.asp" method="post">
					<table align="center" border="0" cellspacing="0" cellpadding="0" style="width:400px;font-weight:bold;" id="TabForm">
						...
						<tr style="height:20px; font-size:1px">
                            <td align="center" valign="center" colspan="3">
                            	<b class="Titre_2"><u>Informations liées au budget annuel</u></b><br><br>
                            </td>
                        </tr>
                        <tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
							...
							<td align="left" valign="center">
								<input type="text" name="TAnnee" id="TAnnee" maxlength="50" style="width:210px;" value="<%=Email%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						 <tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
								<input type="text" name="TTypeCotisation" id="TTypeCotisation" maxlength="20" style="width:210px;" value="<%=Tel%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						<tr style="height:20px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
								<input type="text" name="TBudgetAnnuel" id="TBudgetAnnuel" maxlength="20" style="width:210px;" value="<%=Tel%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						<tr style="height:20px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
						...
						<tr style="height:10px; font-size:1px">
							...
							<button name="BTValider" id="BTValider" type="button" class="btn btn-outline-primary" value="Ajouter"  alt="Ajouter" title="Ajouter" onclick="javascript:envoyer();">Ajouter</button>                            </td>
                            </td>
                        </tr>
