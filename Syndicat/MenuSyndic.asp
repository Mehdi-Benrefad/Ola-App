                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown "  style="padding-right:30px;">
                     ...
                     <li class="nav-item dropdown <%=li1%>"  style="padding-right:30px;">
                        <a class="nav-link dropdown-toggle" href="#"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Cotisations&nbsp;&nbsp;&nbsp;</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                    ...
                    <li class="nav-item dropdown <%=li2%>"  style="padding-right:30px;">
                        <a class="nav-link dropdown-toggle" href="#"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Depenses&nbsp;&nbsp;&nbsp;</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                    ...
                    <li class="nav-item dropdown <%=li3%>" style="padding-right:30px;">
                        <a class="nav-link dropdown-toggle" href="#"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Banque</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                    ...
                    <li class="nav-item dropdown <%=li4%>" style="padding-right:30px;">
                        <a class="nav-link dropdown-toggle" href="#"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Budget Annuel</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown09">
